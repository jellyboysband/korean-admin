<template>
  <nav class="vuestic-navbar navbar navbar-toggleable-md">
    <div class="vuestic-navbar__logo navbar-brand-container align--center justify--start">
      <router-link class="navbar-brand" :to="{name : 'admin__products'}">
        <slot name="logo" />
      </router-link>
    </div>
    <div class="va-row vuestic-navbar__content">
      <div class="header-elem-wrapper menu-icon-container justify--start col">
        <slot name="selector"></slot>
      </div>
      <div class="header-elem-wrapper navbar-text flex offset--md3 md5 d-none d-lg-flex">
